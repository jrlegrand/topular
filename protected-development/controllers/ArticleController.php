...
class ArticleController extends Controller
{
	...
	public $meta_image = null;
	public $meta_url = null;
	...
	public function actionView($id)
	{
		...
		$this->meta_type = 'article';
		$this->meta_title = $model->title;
		$this->meta_url = $model->url;
		if ($model->summary)
			$this->meta_description = substr(strip_tags(str_replace('"', "'", $model->summary)), 0, 200);
		if ($model->image_url)
			$this->meta_image = $model->image_url;
